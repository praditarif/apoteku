...
");
        ...
        <section class="container mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
                ...
                <div>
                    <h2 class="text-xl font-bold text-white">Penjualan Hari Ini</h2>
                    <div class="flex items-center text-3xl mt-2 text-white">
                        <p>Rp.</p>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px"
                    fill="#FFFFFF">
                    <path
                        d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Z" />
                </svg>
            </div>
            ...
            <div
                class="bg-gradient-to-r from-green-400 to-blue-500 p-6 rounded-lg shadow-lg flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-white">Total Obat Tersedia</h2>
                    <p class="text-3xl mt-2 text-white"><?php echo $obat['total_obat']; ?></p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px"
                    fill="#FFFFFF">
                    <path
        ...
        <script>
            ...
            // Membuat gradien warna untuk batang chart
            var gradient = ctx.createLinearGradient(0, 0, 0, 400); // Gradien vertikal
            gradient.addColorStop(0, 'rgba(34, 197, 94, 0.7)'); // Warna hijau muda (from-green-400)
            gradient.addColorStop(1, 'rgba(59, 130, 246, 0.7)'); // Warna biru muda (to-blue-500)
            ...
            var pendapatanChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: gradient, // Menggunakan gradien sebagai background
                        borderColor: 'rgba(34, 197, 94, 1)', // Warna hijau solid untuk border
                        borderWidth: 1
                    }]
                },
                options: {
