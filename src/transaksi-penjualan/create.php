...
<body>
    <form method="POST">
        <div class="grid grid-cols-1 gap-4">
            ...
            <div>
                <label for="Kode_Jenis_Layanan">Kode Jenis Layanan</label>
                <input type="text" name="Kode_Jenis_Layanan" class="input input-bordered input-primary w-full max-w-xs">
            </div>

            <div>
                <label for="Kode_Provider_CPT">Kode Provider CPT</label>
            ...
            <div>
                <label for="Sumber_Pembayaran">Sumber Pembayaran</label>
